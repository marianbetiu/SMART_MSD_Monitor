...
namespace Data.ViewModels
{
    public class HomeIndexViewModel : Shared._BaseEntityViewModel
    {
        ...
        public List<string> MSLLevels { get { return new List<string>() { "5A", "5", "4", "3", "2A", "2", "1" }; } }
        public string selectedMSL { get; set; }
        public HomeIndexViewModel()
        {
            Items = new List<HomeItemViewModel>();
        }

        public async Task<List<HomeItemViewModel>> GetItems(int qty, int remTime, string msl)
        {
            return await Models.HomeModel.GetItems(qty, remTime, msl);
        }
